...
The image tag is: `mzgit.io/emzi0767/ioq3-universal/ioq3-universal:latest`
...
docker run -it --read-only \
  ...
  -p 27960:27960/udp \
  --name=quake3 \
  mzgit.io/emzi0767/ioq3-universal/ioq3-universal:latest
```
...
`mzgit.io/emzi0767/ioq3-universal/ioq3-mikrotik:latest`.
...
architecture:
- CHR (x64): `docker pull --platform=linux/amd64 mzgit.io/emzi0767/ioq3-universal/ioq3-mikrotik:latest`
- ARM: `docker pull --platform=linux/arm/v7 mzgit.io/emzi0767/ioq3-universal/ioq3-mikrotik:latest`
- ARM64/CHR (AMPERE): `docker pull --platform=linux/arm64/v8 mzgit.io/emzi0767/ioq3-universal/ioq3-mikrotik:latest`
...
`docker save mzgit.io/emzi0767/ioq3-universal/ioq3-mikrotik:latest -o quake3.tar`. You will have to
...
[0]: https://mzgit.dev/Emzi0767/ioq3-universal/-/packages
[1]: https://github.com/Emzi0767/ioq3-universal/releases
[2]: https://mzgit.dev/Emzi0767/ioq3-universal/container_registry
